...
import { ShieldCheck, Users, Zap, Award, ExternalLink, Twitter, Mail } from "lucide-react";

export const metadata: Metadata = {
  title: "About Us | ATY Digital Store",
  description:
    "Meet the independent editorial team behind ATY Digital Store. Real reviews, zero sponsored content.",
  alternates: { canonical: "https://atydigitalstore.com/about" },
  openGraph: {
    title: "About ATY Digital Store",
    description: "Independent tech reviews with no sponsored content.",
    type: "website",
...
const team = [
  ...
  },
  {
    ...
    bio: "Sara covers the Apple and Android ecosystems full-time. She tests every product for a minimum of 30 days before publishing. Her iPhone 15 Pro long-term test ran for 11 months.",
...
const values = [
  {
    ...
    body: "No brand pays to appear on ATY Digital. Every product was selected, purchased, and tested by our team. We keep editorial and commercial decisions completely separate.",
  },
  {
    icon: Zap,
    color: "bg-indigo-50 text-indigo-600 border-indigo-100",
    title: "Real-World Testing",
    body: "We test products the way you actually use them, not in controlled lab conditions. Six-month keyboard tests, drop-tested cases, benchmarked monitors after warm-up.",
  },
  {
    icon: Users,
    color: "bg-violet-50 text-violet-600 border-violet-100",
    title: "Transparent Affiliates",
    body: "ATY Digital earns commissions through affiliate links, clearly marked with a badge. They never influence our rankings. We have recommended against products from our highest-paying partners.",
  },
  {
    icon: Award,
    color: "bg-amber-50 text-amber-600 border-amber-100",
    title: "Corrections Policy",
    body: "When we get things wrong, we correct the record publicly at the top of the affected article with the date. We do not quietly edit mistakes out of published reviews.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="bg-white border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-16 pb-14">
          ...
          <p className="text-lg text-slate-500 leading-relaxed max-w-2xl mb-8">
            ...
            without sponsored rankings, and without the vague hedging that makes most tech reviews useless.
          </p>
          ...
          <div>
            ...
            <div className="space-y-4 text-slate-600 text-sm leading-relaxed">
              <p>
                ...
                He spent two weeks reading reviews and realised that every top-ranking article
                was either written by someone who used the board for three days, or was quietly
                funded by the brands being ranked.
              </p>
              <p>
                He built ATY Digital Store to be the site he wished existed: one where the
                methodology is published, the test periods are real, the affiliate relationships
                are disclosed, and the conclusion is honest even when it costs a commission.
              </p>
              <p>
                Today, a team of three full-time editors publishes reviews across Apple, Android,
                PC peripherals, desk setups, and digital tools. Every recommendation is backed
                by a minimum 30-day test period.
              </p>
            </div>
            <Link
              href="/blog"
              className="inline-flex items-center gap-2 mt-7 text-sm font-bold text-indigo-600 hover:text-indigo-700 transition-colors"
            >
      ...
      <section className="bg-white border-y border-slate-100 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-slate-500 text-sm mb-10 max-w-xl">
            These are not aspirational principles &mdash; they are enforced policies that every
            piece of content on this site is held to.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        ...
        <p className="text-slate-500 text-sm mb-10 max-w-xl">
          Three editors, zero freelance content farms. Everything published under our bylines
          was written by the person who actually did the testing.
        </p>
        <div className="space-y-6">
          {team.map((member) => (
            <article
              key={member.name}
              className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm flex flex-col sm:flex-row gap-5"
            >
                ...
                <div className="flex flex-wrap items-start justify-between gap-3 mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      className="flex items-center justify-center w-8 h-8 text-slate-400 hover:text-slate-700 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl transition-all"
                    >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  ATY Digital Store is a participant in the Amazon Services LLC Associates Program
                  and other affiliate programmes. When you click a Verified Link badge and make a
                  purchase, we may earn a commission at no extra cost to you. Affiliate relationships
                  never influence our editorial rankings or review conclusions.{" "}
                  <Link href="/privacy#affiliate" className="text-indigo-500 hover:underline font-medium">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-16 text-center">
        ...
        <p className="text-slate-500 text-sm mb-7 max-w-md mx-auto">
          We read every message. For press inquiries, product corrections, or partnership proposals,
          reach out directly.
        </p>
        <Link
          href="/contact"
          className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3.5 px-7 rounded-xl transition-colors text-sm"
        >
